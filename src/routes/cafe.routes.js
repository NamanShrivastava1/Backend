...
router.post('/cafeinfo', validateCafe, userMiddleware.authenticateUser, cafeController.createCafe);

router.get('/showCafe', userMiddleware.authenticateUser, cafeController.showCafeInfo);

router.post('/menu', validateMenu, cafeMiddleware.authenticateCafe, cafeController.addMenuItems);
